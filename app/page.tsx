...
export default function Page() {
  ...
  return <><div className={`cursor ${cursor.active ? 'cursor-active' : ''}`} style={{ transform: `translate3d(${cursor.x}px, ${cursor.y}px, 0)` }} />
    ...
    <main id="top">
      <section id="home" className="hero page-pad"><div className="hero-copy reveal"><div className="eyebrow"><span className="lime-dot" /> HELLO, I&apos;M</div><h1>ANSHUMAN<br /><span>PANDEY</span></h1><p className="hero-intro">I build digital experiences, security systems and things that shouldn&apos;t look boring.</p><div className="hero-actions"><a className="lime-button" href="#projects">EXPLORE WORK <ArrowUpRight size={16} /></a><a className="text-button" href="#contact">DOWNLOAD CV <ArrowDownRight size={16} /></a></div><div className="identity-labels"><span>CYBERSECURITY</span><span>SECURITY OPERATIONS</span><span>CREATIVE TECHNOLOGY</span></div></div><div className="hero-art reveal"><SystemVisual /></div><div className="scroll-cue"><span>SCROLL TO EXPLORE</span><ArrowDownRight size={16} /></div></section>
      <section className="stats page-pad reveal"><div><strong>15<span>+</span></strong><small>SECURITY TOOLS</small></div><div><strong>06<span>+</span></strong><small>PROJECTS BUILT</small></div><div><strong>100<span>%</span></strong><small>DEDICATION</small></div><div><strong>âˆž</strong><small>ALWAYS LEARNING</small></div><div><strong>24<span>/7</span></strong><small>CURIOSITY MODE</small></div></section>
      <section id="about" className="about page-pad section-pad"><div className="section-kicker reveal"><span>01</span><span>ABOUT / THE PERSON BEHIND THE SYSTEM</span></div><div className="about-grid"><h2 className="reveal">I LIKE BUILDING<br />THINGS THAT<br />MAKE PEOPLE<br />LOOK <span>TWICE.</span></h2><div className="about-side reveal"><div className="profile-portrait"><img src="/anshuman-profile.png" alt="Portrait of Anshuman Pandey" /><div className="portrait-scan" /><span>PROFILE / 2026</span><i /></div><div className="about-description"><span>CYBERSECURITY / SOC</span><p>Systems, security operations, threat detection<br />and defensive technology.</p></div><div className="profile-data"><div><small>BASED IN</small><b>DELHI, INDIA</b></div><div><small>FOCUS</small><b>CYBERSECURITY / SOC</b></div><div><small>CURRENTLY</small><b>BUILDING &amp; LEARNING</b></div><div><small>EDUCATION</small><b>BCA GRADUATE</b></div></div></div></div></section>
      ...
      <section id="contact" className="contact page-pad section-pad"><div className="contact-content reveal"><div className="section-kicker"><span>06</span><span>CONTACT / START A CONVERSATION</span></div><h2>LET&apos;S MAKE<br />SOMETHING <span>INTERESTING.</span></h2><a className="lime-button contact-button" href="mailto:anshuman@example.com">LET&apos;S CONNECT <ArrowUpRight size={18} /></a></div><div className="contact-links reveal"><a href="mailto:anshuman@example.com"><Mail size={18} /><span>EMAIL</span><b>anshuman@example.com</b><ArrowUpRight size={18} /></a><a href="https://linkedin.com" target="_blank" rel="noreferrer"><Users size={18} /><span>LINKEDIN</span><b>CONNECT WITH ME</b><ArrowUpRight size={18} /></a><a href="https://github.com" target="_blank" rel="noreferrer"><GitBranch size={18} /><span>GITHUB</span><b>SEE THE BUILDS</b><ArrowUpRight size={18} /></a><div className="contact-location"><span>LOCATION</span><b>DELHI, INDIA</b></div></div></section>
    </main>
