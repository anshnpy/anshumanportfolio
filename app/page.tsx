...
const projects = [
  { number: '01', title: 'SOC HOME LAB / SIEM DASHBOARD', description: 'A practical Security Operations environment for monitoring, detection, SIEM workflows and incident investigation.', tags: 'SOC / SIEM / MONITORING / BLUE TEAM', type: 'soc', github: 'https://github.com/anshnpy/soc-home-lab', status: 'COMPLETED' },
  { number: '02', title: 'INCIDENT RESPONSE & INVESTIGATION PLATFORM', description: 'A structured platform for alert triage, investigation, evidence handling, timelines, IOCs and incident response workflows.', tags: 'INCIDENT RESPONSE / INVESTIGATION / DFIR', type: 'incident', status: 'BUILDING' },
  { number: '03', title: 'MALWARE ANALYSIS SANDBOX', description: 'An isolated malware-analysis environment for safe static analysis, behavioral observation, network monitoring and IOC extraction.', tags: 'MALWARE / SANDBOX / ANALYSIS', type: 'malware', status: 'BUILDING' },
  { number: '04', title: 'NETWORK IDS & SECURITY MONITORING', description: 'A network-defense lab for traffic visibility, intrusion detection, suspicious activity monitoring and alert investigation.', tags: 'NETWORK / IDS / MONITORING', type: 'network-ids', status: 'BUILDING' },
  { number: '05', title: 'MITRE ATT&CK ATTACK SIMULATION LAB', description: 'An authorized lab for simulating defensive-security scenarios, generating telemetry and mapping observed behavior to MITRE ATT&CK.', tags: 'MITRE ATT&CK / SIMULATION / DETECTION', type: 'mitre', status: 'BUILDING' },
  { number: '06', title: 'AI SECURITY ASSISTANT / SOC COPILOT', description: 'An AI-assisted security workspace for alert explanation, log analysis, IOC extraction, investigation guidance and report generation.', tags: 'AI / SOC / SECURITY AUTOMATION', type: 'ai', status: 'BUILDING' },
  { number: '07', title: 'DIGITAL FORENSICS & DFIR PLATFORM', description: 'A forensic investigation workflow for evidence handling, artifact analysis, timeline reconstruction and incident reporting.', tags: 'DFIR / FORENSICS / INVESTIGATION', type: 'dfir', status: 'BUILDING' },
  { number: '08', title: 'THREAT INTELLIGENCE PLATFORM', description: 'A threat-intelligence workspace for IOC collection, enrichment, scoring, relationships and analyst-focused investigation.', tags: 'THREAT INTEL / IOCS / ENRICHMENT', type: 'network', status: 'BUILDING' },
  { number: '09', title: 'SOAR / SECURITY AUTOMATION PLATFORM', description: 'A security-automation platform for alert-driven playbooks, enrichment, investigation workflows and repeatable SOC actions.', tags: 'SOAR / AUTOMATION / PLAYBOOKS', type: 'soar', status: 'BUILDING' },
  { number: '10', title: 'CLOUD SECURITY MONITORING LAB', description: 'A cloud-security monitoring environment focused on identity, activity logs, configuration changes, permissions and suspicious behavior.', tags: 'CLOUD / SECURITY / MONITORING', type: 'cloud', status: 'BUILDING' },
]
